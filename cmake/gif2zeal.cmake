...
# COMPRESSED: Enable RLE compression for the generated tile data.
# UNIQUE: Remove duplicate tiles from the generated tileset.
# TILEMAP: Generate a `.ztm` tilemap output in addition to `.zts` and `.ztp`.
# VERBOSE: Enable verbose output from the conversion script.
# DEBUG: Enable debug output from the conversion script.
# BIT <bits-per-pixel>: Set the output bit depth.
# COLORS <max-colors>: Limit the generated palette to the given number of colors.
# STRIP <tile-count>: Remove the given number of tiles from the end of the output.
# FILES <gif> [<gif>...]: One or more input GIF files to convert.
